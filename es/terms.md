...
Las partes acuerdan que Videsk SpA sólo es un canal de comunicación, y no tiene decisión, injerencia ni responsabilidad alguna en las acciones que cada usuario realice o incurra en el uso de los servicios de Videsk SpA. Para evitar dudas, lo dispuesto en este párrafo se refiere exclusivamente al contenido y comunicaciones que los usuarios intercambian entre sí a través de los servicios (mensajes, video sesiones, archivos compartidos en la sesión y similares), y **no aplica al manejo por parte de Videsk SpA de datos obtenidos mediante APIs de Google**, respecto de los cuales Videsk SpA es responsable conforme a la [Política de Datos del Usuario de los Servicios API de Google](https://developers.google.com/terms/api-services-user-data-policy) y a la sección "Datos de Usuario de Servicios API de Google" de nuestra Política de Privacidad.
...
**Excepción respecto de datos obtenidos mediante APIs de Google.** Sin perjuicio de lo dispuesto en el párrafo anterior, la licencia que el usuario otorga a Videsk SpA **no aplica** a información obtenida desde APIs de Google. Respecto de dicha información:

1. Videsk SpA **no recibe** licencia transferible, sublicenciable, perpetua, ni el derecho a crear obras derivadas, distribuir, mostrar públicamente, ejecutar o explotar comercialmente los datos de Google.
2. El uso por parte de Videsk SpA de los datos de Google se limita exclusivamente a proveer y mejorar las funcionalidades visibles y prominentes descritas en la sección "Datos de Usuario de Servicios API de Google" de nuestra Política de Privacidad.
3. La licencia respecto de datos de Google **no subsiste** tras la revocación del acceso por parte del usuario o la desconexión de la integración: Videsk SpA elimina los tokens y los identificadores asociados dentro de los plazos establecidos en la Política de Privacidad.
4. En todo lo relativo a datos de Google, Videsk SpA se rige exclusivamente por la [Política de Datos del Usuario de los Servicios API de Google](https://developers.google.com/terms/api-services-user-data-policy), incluyendo los requisitos de Uso Limitado (*Limited Use*), los cuales prevalecen sobre cualquier disposición más amplia contenida en estos Términos y Condiciones.
